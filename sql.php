<?php
  ...
  $conn->query("CREATE TABLE IF NOT EXISTS repeats(eventid INT, day INT, PRIMARY KEY(eventid, day), FOREIGN KEY (eventid) REFERENCES events (eventid) ON DELETE CASCADE);");
 ?>
